...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস আরিফুল রে হাঙ্গা করো😶👻😘",
    "miss u too": "হুম আমি ও তোমাকে Miss করি... কিন্তু আরিফুল বস বেশি করে 😏💖",
    ...
    "good night": "Sweet Dream babu… তবে আগে আরিফুল বস কে GN বলে নিও 😏💤",
    "tor ball": "~ এখনো বাল উঠে নাই নাকি তোমার?? 🤖",
    "shahadat": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ SHAHADAT ARIFUL ☜\nFacebook: https://www.facebook.com/profile.php?id=100082903073384\nWhatsApp: +96599894039",
    "admin": "He is ARIFUL ISLAM তাকে সবাই Admin ARIFUL হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস আরিফুল রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵"
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝐀𝐑𝐈𝐅𝐔𝐋 𝐈𝐒𝐋𝐀𝐌💖",
    ...
    "ki koros": "বস আরিফুল এর সাথে প্রেমে ব্যস্ত আছি 😏💘",
    "kire bot": "হ্যাঁ সবাই কেমন আছেন আপনার ওই খানে উম্মাহ 😘😽🙈",
    "valo aso": "হ্যাঁ রে প্রিও, বস আরিফুল এর দোয়ায় ভালো আছি 😌💞",
    "pagol": "হুম পাগল, কিন্তু তোমারই পাগল 😏😂",
    "breakup": "চিন্তা করিস না… আরিফুল বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি তোর বস আরিফুল এর ChatBot 😏",
    "umm": "এতো Umm কেনো জানু… কিছু বলবা? 😉",
    "hmm": "Hmmm কিসের হুমম জানু 🥵",
    "love": "Love করলে সরাসরি আরিফুল বস কে বল জানু 😻🔥"
  };
